...
export const STAD_TEMPLATES_RUW = {
  nl: {
    ...
    "springkussen": (s) => ({
      title: `Springkussen buiten in ${s}: kan het qua wind?`,
      description: `Kan het springkussen vandaag buiten in ${s}? De check zoekt het rustigste, droogste blok en let op wind en windstoten. Gratis.`,
      h1: `Kan het springkussen buiten in ${s}?`,
    }),
    "speeltuin": (s) => ({
      title: `Naar de speeltuin in ${s}: is het speeltuinweer?`,
      description: `Kun je vandaag met de kinderen naar de speeltuin in ${s}? De check zoekt het fijnste droge blok en let op kou, hitte en zon. Gratis.`,
      h1: `Kan ik naar de speeltuin in ${s}?`,
    }),
    "bestrating-leggen": (s) => ({
      title: `Bestrating leggen in ${s}: is het bestratingsweer?`,
      description: `Kun je vandaag tegels of klinkers leggen in ${s}? De check zoekt het beste droge blok en let op regen, temperatuur en nachtvorst. Gratis.`,
      h1: `Kan ik bestrating leggen in ${s}?`,
    }),
    "dekbed-luchten": (s) => ({
      title: `Dekbed luchten in ${s}: is het luchtweer?`,
      description: `Kun je vandaag je dekbed of beddengoed buiten luchten in ${s}? De check zoekt het droogste, zonnigste blok. Gratis.`,
      h1: `Kan ik mijn dekbed buiten luchten in ${s}?`,
    }),
    "buitenkraan-aftappen": (s) => ({
      title: `Buitenkraan aftappen in ${s}: komt er vorst?`,
      description: `Moet je in ${s} de buitenkraan afsluiten en aftappen tegen vorst? De check kijkt naar de komende nachten. Gratis.`,
      h1: `Moet ik de buitenkraan aftappen in ${s}?`,
    }),
    "onkruid": (s) => ({
  ...
  en: {
    ...
    "springkussen": (s) => ({
      title: `Bouncy castle outside in ${s}: is the wind ok?`,
      description: `Can the bouncy castle go outside in ${s} today? The check finds the calmest, driest window and watches wind and gusts. Free.`,
      h1: `Can the bouncy castle go outside in ${s}?`,
    }),
    "speeltuin": (s) => ({
      title: `Playground in ${s}: is it playground weather?`,
      description: `Can you take the kids to the playground in ${s} today? The check finds the nicest dry window and watches cold, heat and sun. Free.`,
      h1: `Can we go to the playground in ${s}?`,
    }),
    "bestrating-leggen": (s) => ({
      title: `Laying paving in ${s}: is it paving weather?`,
      description: `Can you lay tiles or setts in ${s} today? The check finds the best dry window and watches rain, temperature and night frost. Free.`,
      h1: `Can I lay paving in ${s}?`,
    }),
    "dekbed-luchten": (s) => ({
      title: `Airing a duvet in ${s}: is it airing weather?`,
      description: `Can you air your duvet or bedding outside in ${s} today? The check finds the driest, sunniest window. Free.`,
      h1: `Can I air my duvet outside in ${s}?`,
    }),
    "buitenkraan-aftappen": (s) => ({
      title: `Draining the outdoor tap in ${s}: is frost coming?`,
      description: `Should you shut off and drain the outdoor tap in ${s} against frost? The check looks at the coming nights. Free.`,
      h1: `Should I drain the outdoor tap in ${s}?`,
    }),
    "onkruid": (s) => ({
...
export const ANKER_TERM_RUW = {
  nl: {
    ...
    "muggen": "Muggenweer",
    "springkussen": "Springkussenweer",
    "speeltuin": "Speeltuinweer",
    "bestrating-leggen": "Bestratingcheck",
    "dekbed-luchten": "Dekbedcheck",
    "buitenkraan-aftappen": "Buitenkraancheck",
  ...
  en: {
    ...
    "springkussen": "Bouncy castle weather",
    "speeltuin": "Playground weather",
    "bestrating-leggen": "Paving check",
    "dekbed-luchten": "Bedding check",
    "buitenkraan-aftappen": "Outdoor tap check",
