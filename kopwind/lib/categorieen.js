...
export const CATEGORIEEN = kies({
  nl: [
    ...
    { id: "huis-tuin", slug: "huis-tuin-auto", titel: "Huis en auto", kort: "Was, auto wassen, ramen, klussen", intro: "De was buiten, de auto wassen, ramen zemen of een klus? De praktische checks die je dag rond het huis op het weer plannen, met het beste moment om te beginnen.", icoon: "druppel", kleur: "#8C6239" },
    { id: "tuin", slug: "tuin-planten", titel: "Tuin en planten", kort: "Maaien, snoeien, onkruid, water geven", intro: "Wat kan er vandaag in de tuin? Van de maaibeurt tot de gieter: deze checks wegen het weer en het seizoen, zodat je precies weet welke tuinklus vandaag loont en welke je beter uitstelt.", icoon: "spruit", kleur: "#5A7D3C" },
    ...
    { id: "winter", slug: "winter-veiligheid", titel: "Winter en veiligheid", kort: "Krabben en gladheid", intro: "Moet ik krabben, en is het glad op de weg? De winterchecks die je ochtend en je rit veiliger maken, met uitleg waarom heldere nachten juist verraderlijk zijn.", icoon: "vlok", kleur: "#44607A" },
  ],
  en: [
    ...
    { id: "kleding", slug: "clothing", titel: "Clothing", kort: "What to wear today?", intro: "Coat or no coat, shorts or trousers, T-shirt or jumper? The clothing checks look at the feel per part of the day, not the bare thermometer.", icoon: "shirt", kleur: "#7A5EA8" },
    { id: "buiten", slug: "outdoors-leisure", titel: "Outdoors and leisure", kort: "Patio, barbecue and more", intro: "Can you be outside today? From the first patio drink to a barbecue on a mild evening: see whether the weather cooperates with your plans, and at what moment.", icoon: "parasol", kleur: "#C24E3F" },
    ...
    { id: "huis-tuin", slug: "home-garden-car", titel: "Home and car", kort: "Laundry, car wash, windows, DIY", intro: "Laundry outside, washing the car, cleaning windows or a DIY job? The practical checks that plan your day around the house on the weather, with the best moment to start.", icoon: "druppel", kleur: "#8C6239" },
    { id: "tuin", slug: "garden-plants", titel: "Garden and plants", kort: "Mowing, pruning, weeding, watering", intro: "What can happen in the garden today? From the mowing round to the watering can: these checks weigh the weather and the season, so you know exactly which garden job pays off today and which one can wait.", icoon: "spruit", kleur: "#5A7D3C" },
    ...
    { id: "winter", slug: "winter-safety", titel: "Winter and safety", kort: "Scraping and icy roads", intro: "Do I need to scrape, and are the roads icy? The winter checks that make your morning and your ride safer, and why clear nights are the treacherous ones.", icoon: "vlok", kleur: "#44607A" },
  ],
});
