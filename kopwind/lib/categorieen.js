...
export const CATEGORIEEN = kies({
  nl: [
    { id: "regen", slug: "regen-en-droog", titel: "Regen en droog", kort: "Word ik nat, wanneer regent het, paraplu mee", intro: "Twijfel je of het vandaag droog blijft? Hier zie je direct of je nat wordt, wanneer de regen valt en of een paraplu slim is. Geen algemeen weerbericht, maar een concreet antwoord voor jouw dag.", icoon: "druppel", kleur: "#3C7DC4" },
    ...
    { id: "buiten", slug: "buiten-vrije-tijd", titel: "Buiten en vrije tijd", kort: "Terras, barbecue en meer", intro: "Kan het buiten? Van de eerste terrasborrel tot de barbecue: hier vind je of het weer meezit voor je vrije tijd.", icoon: "parasol", kleur: "#B5691E" },
    ...
    { id: "huis-tuin", slug: "huis-tuin-auto", titel: "Huis, tuin en auto", kort: "Was, auto wassen, tuinieren, klussen", intro: "Was buiten, auto wassen, tuinieren of klussen? De praktische checks die je dag rond het huis plannen op het weer.", icoon: "druppel", kleur: "#4E9A86" },
    ...
    { id: "winter", slug: "winter-veiligheid", titel: "Winter en veiligheid", kort: "Krabben en gladheid", intro: "Moet ik krabben, en is het glad op de weg? De winterchecks die je ochtend en je rit veiliger maken.", icoon: "vlok", kleur: "#5B7A99" },
  ],
  en: [
    { id: "regen", slug: "rain-or-dry", titel: "Rain or dry", kort: "Will I get wet, when will it rain, umbrella", intro: "Wondering whether it stays dry today? Here you see straight away whether you'll get wet, when the rain falls and whether an umbrella is smart. Not a general forecast, but a concrete answer for your day.", icoon: "druppel", kleur: "#3C7DC4" },
    ...
    { id: "buiten", slug: "outdoors-leisure", titel: "Outdoors and leisure", kort: "Patio, barbecue and more", intro: "Can you be outside? From the first patio drink to the barbecue: here's whether the weather cooperates for your free time.", icoon: "parasol", kleur: "#B5691E" },
    ...
    { id: "huis-tuin", slug: "home-garden-car", titel: "Home, garden and car", kort: "Laundry, car wash, gardening, DIY", intro: "Laundry outside, washing the car, gardening or DIY? The practical checks that plan your day around the house on the weather.", icoon: "druppel", kleur: "#4E9A86" },
    ...
    { id: "winter", slug: "winter-safety", titel: "Winter and safety", kort: "Scraping and icy roads", intro: "Do I need to scrape, and are the roads icy? The winter checks that make your morning and your ride safer.", icoon: "vlok", kleur: "#5B7A99" },
  ],
});
