...
export const CATEGORIEEN = kies({
  nl: [
    ...
    { id: "huis-tuin", slug: "huis-tuin-auto", titel: "Huis, tuin en auto", kort: "Was, auto wassen, tuinieren, klussen", intro: "De was buiten, de auto wassen, tuinieren of een klus? De praktische checks die je dag rond het huis op het weer plannen, met het beste moment om te beginnen.", icoon: "druppel", kleur: "#8C6239" },
  ...
  en: [
    ...
    { id: "huis-tuin", slug: "home-garden-car", titel: "Home, garden and car", kort: "Laundry, car wash, gardening, DIY", intro: "Laundry outside, washing the car, gardening or a DIY job? The practical checks that plan your day around the house on the weather, with the best moment to start.", icoon: "druppel", kleur: "#8C6239" },
