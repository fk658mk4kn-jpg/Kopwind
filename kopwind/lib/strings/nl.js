...
export const S = {
  ...
  hub: {
    ...
    populairKop: "Populaire keuzehulpen",
    recentKop: "Recent gebruikt",
    themaKop: "Kies een thema",
    alleChecksTitel: "Alle keuzehulpen op een plek",
    ...
    landnaam: "Nederland",
    checksVanVandaag: "Waar let je vandaag op?",
  },
  stem: {
  ...
  categorie: {
    kop: "Categorieen",
    intro: "Blader per onderwerp en vind de keuzehulpen die bij je dag horen.",
    bekijk: "Bekijk categorie",
    directAntwoord: "Direct antwoord",
    alleChecks: "Alle keuzehulpen in deze categorie",
