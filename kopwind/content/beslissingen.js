  ...
  nl: [
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "zwembad-opzetten", zoek: ["zwembad", "opzetten", "opblaasbad", "zwemmen"] },
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "beton-storten", zoek: ["beton", "storten", "cement", "fundering", "vloer"] },
        { toolId: "dak-op", zoek: ["dak", "goot", "dakpannen", "schoorsteen", "veilig"] },
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "muggen", zoek: ["muggen", "muggenweer", "steken", "muggensteek"] },
      ],
    },
    {
      id: "winter",
  ...
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "zwembad-opzetten", zoek: ["pool", "set up", "inflatable", "swim"] },
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "beton-storten", zoek: ["concrete", "pour", "cement", "foundation", "floor"] },
        { toolId: "dak-op", zoek: ["roof", "gutter", "tiles", "chimney", "safe"] },
    ...
    },
    {
      ...
      items: [
        ...
        { toolId: "muggen", zoek: ["mosquito", "mosquitoes", "bites", "midges"] },
      ],
    },
    {
      id: "winter",
