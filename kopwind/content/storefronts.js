    ...
    buiten: {
      ...
      keuzehulp: {
        ...
        keuzes: [
          ...
          { situatie: "Picknicken of buiten eten in het park", toolId: "picknickweer" },
          { situatie: "Buiten zwemmen in open water", toolId: "buiten-zwemmen" },
          { situatie: "Het water op met sup of kajak", toolId: "suppen-of-kajakken" },
          { situatie: "Vanavond naar de sterren kijken", toolId: "sterrenkijken" },
        ],
      },
      beslislogica: {
    ...
    sport: {
      ...
      keuzehulp: {
        ...
        keuzes: [
          ...
          { situatie: "Buiten trainen: bootcamp, calisthenics, teamsport", toolId: "buiten-sporten" },
          { situatie: "Een potje padel of tennis", toolId: "padel-of-tennis" },
          { situatie: "Een lange wandeling", toolId: "wandelen" },
        ],
      },
      beslislogica: {
    ...
    buiten: {
      ...
      keuzehulp: {
        ...
        keuzes: [
          ...
          { situatie: "A picnic or eating outside in the park", toolId: "picknickweer" },
          { situatie: "Swimming in open water", toolId: "buiten-zwemmen" },
          { situatie: "Getting on the water by SUP or kayak", toolId: "suppen-of-kajakken" },
          { situatie: "Stargazing tonight", toolId: "sterrenkijken" },
        ],
      },
      beslislogica: {
    ...
    sport: {
      ...
      keuzehulp: {
        ...
        keuzes: [
          ...
          { situatie: "Training outside: bootcamp, calisthenics, team sport", toolId: "buiten-sporten" },
          { situatie: "A game of padel or tennis", toolId: "padel-of-tennis" },
          { situatie: "A long walk", toolId: "wandelen" },
        ],
      },
      beslislogica: {
